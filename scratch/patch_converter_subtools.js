...
const subTools = [
  'converter/compress-image/index.html',
  'converter/excel-to-pdf/index.html',
  'converter/jpg-to-pdf/index.html',
  'converter/pdf-to-jpg/index.html',
  'converter/pdf-to-word/index.html',
  'converter/png-to-pdf/index.html',
  'converter/ppt-to-pdf/index.html',
  'converter/split-pdf/index.html'
];

const staticBlockRegex = /<!-- Comprehensive Client-Side Conversion Libraries -->[\s\S]*?<script src="https:\/\/cdn\.jsdelivr\.net\/npm\/xlsx@0\.18\.5\/dist\/xlsx\.full\.min\.js"><\/script>/i;
